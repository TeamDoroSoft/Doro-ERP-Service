...
public record ProductOption(UUID optionId, String name, long additionalPrice, boolean enabled, int displayOrder) {
    ...
    public ProductOption {
        ...
        if (additionalPrice < 0) {
            throw new InvalidPriceException("옵션 추가 금액", additionalPrice);
        }
        if (displayOrder < 0) {
